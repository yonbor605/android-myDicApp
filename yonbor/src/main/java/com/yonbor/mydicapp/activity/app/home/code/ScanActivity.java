...
import com.yonbor.baselib.rxtool.RxAnimationTool;
import com.yonbor.baselib.rxtool.RxBeepTool;
import com.yonbor.baselib.rxtool.RxDataTool;
import com.yonbor.baselib.rxtool.RxPhotoTool;
...
import com.yonbor.mydicapp.utils.RxQrBarTool;
import com.yonbor.mydicapp.view.dialog.RxDialogSure;
import com.yonbor.mydicapp.view.scaner.CameraManager;
import com.yonbor.mydicapp.view.scaner.OnRxScanerListener;
import com.yonbor.mydicapp.view.scaner.PlanarYUVLuminanceSource;
import com.yonbor.mydicapp.view.scaner.decoding.InactivityTimer;
...
public class ScanActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarCompat.hideStatusBarNavigationBar(this);
        ...
        initScanerAnimation();
        //初始化 CameraManager
        CameraManager.init(baseContext);
        hasSurface = false;
    ...
    private void initDialogResult(Result result) {
        ...
        if (rxDialogSure == null) {
            //提示弹窗
            rxDialogSure = new RxDialogSure(baseContext);
        }
        ...
        SharedPreferencesUtil.getInstance().setStringData(AppConstant.SP_KEY_SCAN_CODE, RxDataTool.stringToInt(SharedPreferencesUtil.getInstance().getStringData(AppConstant.SP_KEY_SCAN_CODE)) + 1 + "");
    }
