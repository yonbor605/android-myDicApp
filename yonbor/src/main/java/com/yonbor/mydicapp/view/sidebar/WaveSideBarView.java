package com.yonbor.mydicapp.view.sidebar;
...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.sp_32);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.sp_20);
        if (attrs != null) {
            ...
            mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.dp_20));
            mBallRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.dp_24));
            a.recycle();
        }
