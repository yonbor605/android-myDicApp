...
//    private static final int FOOTER_COLOR = 0xFFFFC445;
  private static final int FOOTER_COLOR = 0xFF00AC8B;
    ...
    protected final int BSSEEID = 0xffff00;;
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        mFooterColor = a.getColor(R.styleable.TitleIndicator_footerColor, FOOTER_COLOR);
        offset = a.getDimension(R.styleable.TitleIndicator_titlePadding, 0);
        ...
        initDraw(mFooterLineHeight, mFooterColor);
        a.recycle();
    }
    ...
    public void setmTextSizeNormal(float mTextSizeNormal) {
        this.mTextSizeNormal = mTextSizeNormal;
    }

    public void setmTextSizeSelected(float mTextSizeSelected) {
        this.mTextSizeSelected = mTextSizeSelected;
    }

    public void setmFooterTriangleHeight(float mFooterTriangleHeight) {
        this.mFooterTriangleHeight = mFooterTriangleHeight;
    }

    public void setmFooterLineHeight(float mFooterLineHeight) {
    ...
    public void setmFooterColor(int mFooterColor) {
    ...
    public void initDraw() {
        ...
        mPaintFooterTriangle = new Paint();
        mPaintFooterTriangle.setStyle(Paint.Style.FILL_AND_STROKE);
        mPaintFooterTriangle.setColor(mFooterColor);
        mInflater = (LayoutInflater) mContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
    ...
    //初始化选项卡
    public void init(int startPos, ArrayList<TabInfo> tabs, ViewPager mViewPager) {
        removeAllViews();
        this.mCurrID = 0;
    ...
    protected void add(int index, String label, int icon) {
        View tabIndicator;
//        if (index < 2) {
...
//        tv.setTextColor(ContextCompat.getColorStateList(mContext, R.color.selected_green_gray));
        if (mTextColor != null) {
    ...
    public int getBSSEEID(){
        return BSSEEID;
    }
    
    public CountView getCountView(int position){
        View view = this.findViewById(BSSEEID + position);
        return (CountView) view.findViewById(R.id.countView);
    }
